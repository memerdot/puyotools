...
namespace VrSharp
{
    public class PvpClutEncoder : VpClutEncoder
    {
        ...
        public PvpClutEncoder(MemoryStream stream, ushort NumClutEntries) : base(stream, NumClutEntries) { }

        /// <summary>
        /// Load a clut from a byte array.
        /// </summary>
        /// <param name="array">Byte array that contains the clut data.</param>
        public PvpClutEncoder(byte[] array, ushort NumClutEntries) : base(array, NumClutEntries) { }
        #endregion
