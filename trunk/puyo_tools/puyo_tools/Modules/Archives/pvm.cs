        ...
        */
        ...
        public override MemoryStream TranslateData(ref Stream stream)
        {
            try
            {
                ...
                for (int i = 0; i < files; i++)
                {
                    ...
                    data.Write(GraphicHeader.GBIX, 4);
                    data.Write((int)0x8);
        ...
        public override Stream FormatFileToAdd(ref Stream data)
        {
            ...
            if (images.Format == GraphicFormat.PVR)
            {
                ...
                if (data.ReadString(0x0, 4) == GraphicHeader.PVRT)
                    return data;
            ...
            try
            {
                ...
                for (int i = 0; i < files.Length; i++)
                {
                    using (FileStream data = new FileStream(files[i], FileMode.Open, FileAccess.Read))
                    {
                        ...
                        int headerOffset = (data.ReadString(0x0, 4) == GraphicHeader.PVRT ? 0x0 : 0x10);
        ...
        public override Archive.Information Information()
        {
            string Name   = "PVM";
            string Ext    = ".pvm";
            string Filter = "PVM Archive (*.pvm)|*.pvm";
            ...
            string[] Settings = new string[] {
                "Add Filenames",
                "Add PVR Pixel Format",
                "Add PVR Dimensions",
                "Add PVR Global Index",
            };
